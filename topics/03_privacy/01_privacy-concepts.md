...
> 対応科目: H00Y2A, H09L2A, H0Q29A ｜ 次: [02 匿名化と差分プライバシー](./02_anonymization-and-dp.md) ｜ 層: 基礎(Layer 1)

「プライバシー」は日常語では曖昧だが、工学として扱うには厳密な語彙が要る。
Pfitzmann と Hansen が提案した用語体系（IETF草稿として公開、プライバシー工学・
脅威モデリング LINDDUN で標準的に使われる）を土台にする。
...
「候補が何人いるか」を確率分布のエントロピーで定量化する方法もある
...
| 暗号化通信の存在自体を検閲者が検出できない（ステガノグラフィ） | 非検知性 |
