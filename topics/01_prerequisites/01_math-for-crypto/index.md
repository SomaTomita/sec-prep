...
| 02 | [群・環・体](02_groups-rings-fields/README.md) | 群・環・体・有限体 GF(p), GF(2^n)・位数（概念別フォルダ: 二項演算→位数→巡回群→環→体→GF(2^n)） |
...
|---|---|
| 01 合同算術 | RSA 鍵生成、DH |
| 02 群・環・体 | DH/ECC の群、AES の GF(2^8) |
| 03 整数論 | RSA・DH の安全性根拠 |
| 04 多項式・イデアル | GF(2^n) 構成、格子暗号・多変数暗号への入口 |
